...
public:
	...
	int helpSiz;
	SEQ_VECTOR <SparseMatrix> helpM;
	SEQ_VECTOR <SEQ_VECTOR<double> > recvCompressedTmp2, sendCompressedTmp;
	SEQ_VECTOR <SparseMatrix> helpG;
	SEQ_VECTOR <SEQ_VECTOR<double> > recvxPrimCluster1, sendxPrimCluster2;
	SEQ_VECTOR <MPI_Request> request_send1, request_send2, request_recv1, request_recv2;
